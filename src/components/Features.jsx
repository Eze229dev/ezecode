        ...
        <Container>
            <div className="max-w-4xl mx-auto py-5 lg:py-10">
                <div className="space-y-4 mb-8 text-center lg:text-start ">
                    ...
                    <p className="body-1 text-n-5">From idea to production-ready frontend.

                         A structured approach to building modern, user-focused interfaces.</p>
                </div>
                <div className="grid sm:grid-cols-2 gap-5 lg:gap-10">
                    {features.map((feature)=>(
                        <div key={feature.id}
                            className="border border-stroke-1 hover:bg-n-8 space-y-8 rounded-xl lg:rounded-2xl p-8 cursor-pointer animate "
